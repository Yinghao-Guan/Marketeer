...
export async function POST(req: Request) {
    try {
        const { bannerConcept, styleLock, logoBase64, brandName, location, description } = await req.json();
                    ...
                    contents: [
                        {
                            ...
                            parts: [
                                ...(logoBase64
                                    ...
                                    : []),
                                {
                                    text: BANNER_PROMPT(brandName, bannerConcept, styleLock.colors, styleLock.style, location || "", description || ""),
                                },
                            ],
                        },
                    ],
